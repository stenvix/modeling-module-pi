...
namespace VirtualLaboratoryPI.Graph.Data
{
    public class EditorObjectManager : IDisposable
    {
        ...
        public EditorObjectManager(GraphAreaExample graphArea, ZoomControl zc)
        {
            ...
            //{
            //    Source = new Uri("component/Templates/ThemedGraphXTemplates.xaml",
        ...
        {
            _edgeBp = new EdgeBlueprint(source, mousePos, new LinearGradientBrush(Color.FromRgb(255,255,255), Color.FromRgb(100, 100, 100), 90));
